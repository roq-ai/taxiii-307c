  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to taxiii, your ultimate destination for seamless online cab booking service. Making your journey easier, one ride at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1569433295058-aaa6338e25c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYWJ8ZW58MHx8fHwxNjkzNjczMjQ5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to taxiii, your ultimate destination for seamless online cab booking service. Making your journey easier, one ride at a time.`}
            </Text>
            <Box
