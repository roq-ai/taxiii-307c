...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'admin_staff.count', 'cab.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('admin_staff', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'admin_staff',
          header: 'Admin Staff',
          accessorKey: 'admin_staff',
          cell: ({ row: { original: record } }: any) => record?._count?.admin_staff,
        }
      : null,
    hasAccess('cab', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'cab',
          header: 'Cab',
          accessorKey: 'cab',
          cell: ({ row: { original: record } }: any) => record?._count?.cab,
        }
      : null,
