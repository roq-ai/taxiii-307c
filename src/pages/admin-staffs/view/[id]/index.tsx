...
import { getAdminStaffById } from 'apiSdk/admin-staffs';
import { AdminStaffInterface } from 'interfaces/admin-staff';

function AdminStaffViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('admin_staff', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/admin-staffs/edit/${id}`} passHref legacyBehavior>
                    <Button
