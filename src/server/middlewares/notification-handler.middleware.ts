...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create': {
    roles: ['business-owner', 'admin-staff'],
    key: 'new-cab-booking',
    tenantPath: ['company', 'cab', 'booking'],
    userPath: [],
  },
  'booking.delete': {
    roles: ['business-owner', 'admin-staff'],
    key: 'cab-booking-cancelled',
    tenantPath: ['company', 'cab', 'booking'],
    userPath: [],
  },
  'cab.update': {
    roles: ['business-owner', 'admin-staff'],
    key: 'cab-status-updated',
    tenantPath: ['company', 'cab'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'admin-staff'];
